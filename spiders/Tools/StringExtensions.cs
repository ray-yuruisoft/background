...
namespace spiders
{
    ...
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Keeps Last numbers, removing anything else
        /// </summary>
        /// <param name="originalString"></param>
        /// <returns></returns>
        public static string KeepLastNumbers(this string originalString)
        {
            return new Regex(@"\d+$").Match(originalString).Value;
        }

        public static string KeepExceptLastNumbers(this string originalString)
        {
            return Regex.Replace(originalString, @"\d+$", string.Empty);
        }
        ...
        /// <summary>
        /// Keeps first numbers, removing anything else
        /// </summary>
        /// <param name="originalString"></param>
        /// <returns></returns>
        public static string KeepFirstNumbers(this string originalString)
        {
            return new Regex(@"^\d+").Match(originalString).Value;
        }
