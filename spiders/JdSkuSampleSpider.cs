...
namespace spiders
{
    ...
    public class JdSkuSampleSpider : EntitySpider
    {
        ...
        protected override void MyInit(params string[] arguments)
        {
            ...
            AddPipeline(new MySqlEntityPipeline("server=localhost;database=spider;uid=root;pwd=admin123456;charset=utf8;SslMode=none"));
    ...
    [EntityTable("spider", "jd_sku", EntityTable.Monday, Indexs = new[] { "Category" }, Uniques = new[] { "Category,Sku", "Sku" })]
